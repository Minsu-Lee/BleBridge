...
## Summary
- 1061 nodes · 1512 edges · 115 communities (77 shown, 38 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 185 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29dd9807`
...
Cohesion: 0.08
Nodes (20): MviActionScope, MviViewModel, CatsClicked, Initialize, RetryClicked, SampleIntent, Failed, Loaded (+12 more)
...
Cohesion: 0.06
Nodes (28): Color, ActionButtonTest, IconButtonTest, Dp, IconButton(), IconButtonMatrixPreviewContent(), IconButtonSelectedMatrixPreviewContent(), IconButtonShape (+20 more)
...
Cohesion: 0.05
Nodes (26): MviIntent, MviMutation, MviSideEffect, MviState, MainScreenTest, Modifier, MainRoute(), MainScreen() (+18 more)
...
- **Why does `AppTheme()` connect `AppTheme` to `MainViewModel`, `ConnectionActivityStatus`, `SplashViewModel`, `SampleScreen`, `SampleCatsScreen`, `ChatContext`, `SampleCatsAppendError`, `AppIcons.kt`, `ConnectionRole`, `LoadingDots`, `SplashBrandContent`, `SampleErrorContent`, `MediaTokens`, `Motion`, `SplashContent`, `CatFactItem`, `SampleCatsAppendLoading`, `SampleCatsErrorContent`, `AppTypography`, `AppColors`, `AppGradients`, `Spacing`?**
